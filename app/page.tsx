    ...
    <Link href={`/products/${product.id}`} className="group block cursor-pointer" data-anim="product-card">
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        {product.originalPrice && (
          <span className="text-[11px] text-[#9E9EA0] line-through">{product.originalPrice}</span>
        )}
      </div>
...
export default function Home() {
  ...
  return (
    <div style={{ backgroundColor: '#faf9f8', color: '#1a1a1a', fontFamily: "'Inter', sans-serif" }}>
      ...
      <section className="flex min-h-[80vh]">
        <div className="flex-1 flex flex-col justify-center px-10 md:px-20 py-16">
          ...
          <div data-anim="hero-cta">
            <Link
              href="/products"
              className="inline-flex items-center gap-3 bg-[#1a1a1a] text-white px-6 py-3 text-[0.85rem] font-medium uppercase tracking-[1px] hover:opacity-80 transition"
            >
              SHOP NOW <ArrowRight />
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {CATEGORIES.map((cat) => (
            <div
              ...
              className="flex flex-col pb-5 px-3 pt-3"
            >
              <img
                src={cat.img}
                alt={cat.label}
      ...
      <div className="mt-14">
        <div className="px-6 md:px-8 pb-6 flex items-baseline justify-between">
          <h2
            data-anim="section-heading"
            className="text-[28px] md:text-[32px] font-normal uppercase tracking-wider"
            style={{ fontFamily: "'Playfair Display', serif" }}
        ...
        <div
          className="flex items-center gap-2 px-6 md:px-8 py-4 overflow-x-auto mb-6"
        ...
        >
          ...
          {FILTER_OPTIONS.map((opt) => (
            <button
              ...
              className="inline-flex items-center h-9 px-4 rounded-full text-[12px] font-medium uppercase tracking-wider whitespace-nowrap transition flex-shrink-0"
              style={{
        ...
        <div
          ...
          className="px-6 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3"
        >
          {NEW_ARRIVALS.map((p) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-12">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3
                className="text-[40px] leading-[0.9] uppercase text-white mb-4"
                style={{ fontFamily: "'Playfair Display', serif" }}
              >
                Dark<br />Utility
              </h3>
          ...
          <div className="flex flex-col gap-2">
            <div
              ...
              style={{ aspectRatio: '4/2.5', background: '#E8E4DC' }}
            >
              <img
              ...
              <div className="relative z-10">
                ...
                <h3
                  className="text-[28px] leading-[0.9] uppercase text-[#111] mb-4"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  Soft<br />Forms
                </h3>
            ...
            <div
              data-anim="collection-tile"
              className="relative flex items-end p-6 overflow-hidden"
              style={{ aspectRatio: '4/2.5', background: '#111' }}
            >
              ...
              <div className="relative z-10">
                ...
                <h3
                  className="text-[28px] leading-[0.9] uppercase text-white mb-4"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  End of<br />Season
                </h3>
      ...
      >
        <div data-anim="cta-text">
          ...
          <p className="text-[12px] text-white/50 mt-1 tracking-wider">
      ...
      {/* ⑥ BEST SELLERS ──────────────────────────────────────────────── */}
      <div className="px-6 md:px-8 pt-14">
        <div className="flex items-baseline justify-between pb-6">
          <h2
            data-anim="section-heading"
            className="text-[28px] md:text-[32px] font-normal uppercase tracking-wider"
        ...
        <div
          data-anim="product-grid"
          className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-3 mb-14"
        >
          {BEST_SELLERS.map((p) => (
            <ProductCard key={p.id} product={p} />
          ))}
      ...
      <div className="px-6 md:px-8 pb-0">
        <div
          data-anim="fade-up"
          style={{ backgroundColor: '#f3efe9' }}
          className="flex flex-col md:flex-row p-8 md:p-10 gap-8 justify-between"
        >
          <div className="flex flex-col justify-center max-w-[280px]">
            <p className="text-[0.75rem] font-medium uppercase tracking-[2px] mb-4 text-[#555]">NEW COLLECTION</p>
            <h2
              style={{ fontFamily: "'Playfair Display', serif" }}
              className="text-3xl font-normal mb-4 leading-[1.2]"
            >
          ...
          <div className="flex gap-3" style={{ height: '320px' }}>
            {[
              ...
              <img key={i} src={src} alt={`Spring ${i + 1}`} className="object-cover flex-1" style={{ height: '100%' }} />
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-8 py-5">
        <div
          data-anim="fade-up"
          style={{ backgroundColor: '#f3efe9' }}
          className="flex flex-col md:flex-row p-8 md:p-10 gap-10"
        >
          ...
          <div className="flex-1">
            <img
              ...
              style={{ height: '280px', borderRadius: '140px 140px 0 0' }}
            />
          </div>
        </div>
      </div>
      ...
      <div
        className="flex flex-wrap justify-between gap-8 px-6 md:px-8 py-12"
        style={{ borderTop: '1px solid #eaeaea' }}
      >
        {FEATURES.map((f) => (
          <div key={f.title} data-anim="feature-item" className="flex items-center gap-4">
            <div style={{ color: '#1a1a1a' }}>{f.icon}</div>
            <div>
              <h4 className="text-[0.85rem] font-semibold mb-1">{f.title}</h4>
              <p className="text-[0.78rem] text-[#555] whitespace-pre-line leading-relaxed">{f.desc}</p>
            </div>
          </div>
        ))}
      </div>
